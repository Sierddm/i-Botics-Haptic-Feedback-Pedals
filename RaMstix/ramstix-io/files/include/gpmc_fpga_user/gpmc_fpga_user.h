...
#ifndef _GPMC_FPGA_USER_H_
#define _GPMC_FPGA_USER_H_
 ...
 *
 * Open the GPMC device. This function should be used with the kernel module.
 * This function will try to open the real time device first. If this fails it will try to open the non real time device.
 *
